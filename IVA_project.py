...
try:
    ...
    steeringAngle = 0.0
    #velocità in funzione dell'altezza delle mani: ACC-> y di una delle due mani, SX-> altezza mano sx, DX-> altezza mano dx
    speed = 0.0
    ...
    while True:
        ...
        #se angolo > 0, sterzo a sx, altrimenti se angolo < 0 sterzo a destra
        ...
        if(status != 0 and -10.0 < steeringAngle < 10.0
            ...
            speed = 380 - max(RightWirst_y[counter], LeftWirst_y[counter])
